...
use crate::{app::CurrentUserContext, components::ui::layout::header::{buttons::SigninButton, dropdown::{ActiveSubmenu, HeaderDropdown}}};
        ...
        <div class="flex items-center gap-2">
            ...
            >
                <Show
                    ...
                    fallback=move || view! { <SigninButton /> }
                >
                    <ProfileMenu
